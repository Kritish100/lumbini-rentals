...
import { X, Heart, MessageCircle, Car, Zap, Bath, Home, Send, Phone, MapPin, CheckCircle2, Tag, Layers } from 'lucide-react'
    ...
    <div className="fixed inset-0 bg-slate-900/60 z-50 overflow-y-auto backdrop-blur-xs flex items-center justify-center p-4 animate-in fade-in duration-200" onClick={onClose}>
      ...
      >
        ...
        <div className="p-6 lg:p-8 overflow-y-auto space-y-8">
            ...
            <div className="lg:col-span-1 flex flex-col justify-between bg-slate-50/40 border border-slate-100 rounded-xl p-5 min-h-[360px]">
              <div className="space-y-5">
                <div>
                  ...
                  <p className="font-heading text-3xl font-extrabold text-orange-600 tracking-tight">
          ...
          {/* SPECIFICATIONS SECTION: Reverted Cards with Adaptive Highlights */}
          <div>
            <h3 className="font-heading text-lg font-bold text-slate-900 mb-4">Core Specifications</h3>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              
              {/* Highlight Candidate: Furnished Status */}
              <div className={`p-4 rounded-xl border transition-colors ${
                property.furnishingStatus && property.furnishingStatus !== 'Unfurnished'
              ...
              {property.category === 'Residential' && (
                <>
                  ...
                  {/* Highlight Candidate: Separate Meter is a major local selling point */}
                  <div className={`p-4 rounded-xl border transition-colors ${
                    property.electricityMeterType === 'Separate' || property.electricityMeterType === 'Sub-Meter'
                      ? 'bg-amber-50/80 border-amber-200/80 shadow-xs' 
                      : 'bg-slate-50 border-slate-100'
                  }`}>
