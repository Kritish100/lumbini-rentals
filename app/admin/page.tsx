    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans pb-20">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a
              href="/"
              target="_blank"
              className="flex items-center gap-1.5 text-xs font-bold uppercase bg-slate-800 hover:bg-slate-700 px-4 py-2 rounded-xl border border-slate-700 transition-all text-slate-200"
            >
              <ExternalLink size={14} /> Public Site
            </a>
            <button
              onClick={handleLogOut}
              className="cursor-pointer rounded-xl bg-slate-100 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-200 hover:text-slate-900 active:scale-[0.98]"
            >
              Logout
            </button>
          </div>
      ...
      <main className="max-w-[1400px] mx-auto px-6 py-8 transition-all duration-300">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
          ...
          <section
            className={`${isSidebarOpen ? "xl:col-span-7" : "xl:col-span-12"} transition-all duration-300`}
          >
            <PropertyList
              properties={properties}
