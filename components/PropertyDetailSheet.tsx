...
export default function PropertyDetailSheet({
  ...
  const handleWhatsAppInquiry = () => {
    const message = encodeURIComponent(
      `Hi! I'm interested in the ${property.type} at ${property.location} (Ref ID: ${property.id}). Please provide more details.`,
    );
        ...
        <div className="p-6 lg:p-8 overflow-y-auto space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2 space-y-4">
              <div className="relative w-full pt-[68%] bg-slate-50 rounded-xl overflow-hidden border border-slate-100 shadow-inner">
                <Image
                  src={property.assets[currentImageIndex] || property.assets[0]}
                  alt={property.type}
                  fill
              ...
              <div className="flex gap-3 overflow-x-auto pb-1 scrollbar-none">
                {property.assets.map((image, index) => (
                  <button
                    key={index}
            ...
            <div className="lg:col-span-1 flex flex-col justify-between bg-slate-50/40 border border-slate-100 rounded-xl p-5 min-h-[360px]">
              ...
              <div className="space-y-2.5 mt-6">
                ...
                >
                  <MessageCircle size={16} className="fill-current" /> Inquire
                  on WhatsApp
                </button>
                <button
          ...
          {/* <div className="pt-4 flex items-center justify-between border-t border-slate-100">
            ...
            >
              <Heart
                size={17}
                className={`transition-transform duration-200 group-hover:scale-110 ${isLiked ? "fill-red-500 text-red-500" : "text-slate-400"}`}
              />
          ...
          {/* <div className="pt-2">
            ...
            <div className="mb-6 flex gap-3">
              ...
              <button
                ...
                className="px-4 py-2.5 bg-orange-600 text-white rounded-xl hover:bg-orange-700 shadow-sm transition-all duration-200 active:scale-95 flex items-center justify-center flex-shrink-0"
              >
                <Send size={16} />
              </button>
            </div>
            ...
            <div className="space-y-3">
              {comments.map((comment) => (
                <div
                  key={comment.id}
                  className="flex gap-3 bg-slate-50/60 border border-slate-100 rounded-xl p-4 animate-in fade-in slide-in-from-bottom-2 duration-200"
                >
